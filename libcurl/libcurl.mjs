        ...
        return 'socket[' + (SOCKFS.nextname.current++) + ']';
          ...
          if (ws) {
            ...
            try {
              ...
              var opts = undefined;var parts = addr.split("/");
if (!url.endsWith("/")) url += "/";
url += parts[0] + ":" + port;
...
if (!Object.getOwnPropertyDescriptor(Module, "WS")) Module["WS"] = () => abort("'WS' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)");
...
const libcurl_version = "0.6.20-dev";
const wisp_version = "0.3.3";
